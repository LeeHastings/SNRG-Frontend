...
public interface PropertiesEditor 
	 ...
	 * @param lid The Layer ID to check in, should be from 
	 ...
	 * @return The property ID of the matching property, or null if there was 
	 * no match
	 * @throws EditorException Thrown if the Layer ID is invalid
	 */
	public Integer 
	 ...
	 * @return The range ID of a range with the requested label, or null if 
	 * there was no match
	...
	/**
	 * Search for a layer with the given ID.  Return its layerID if it exists,
	 * or null otherwise.
	 * @param name The layer Name to search for
	 * @return The layerID for use in methods starting with <code>layer_*</code>
	 * @throws EditorException Thrown if the editor does not support layers
	 */
	public Integer 
	...
	/**
	 * Get the {@link PropertiesEditor} for the edge settings on the given 
	 * layer.
